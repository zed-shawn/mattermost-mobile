/*
user-activity-9zuz5w45rinh5knzxdd3goen8e
{"messages": ["rohitesh.gupta added to the channel by mrjones."], "user_activity": {"allUserIds": ["my1j48jfmidetcio7bi3sdejqy"], "allUsernames": [], "messageData": [[Object]]}}
*/
...
export const PostMetadataSchema = {
    /* 
        ...
        so be sure to properly parse when writing/reading
    */
    name: 'PostMetadata',
    properties: {
